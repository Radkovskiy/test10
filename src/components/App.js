...
🔴 Поскольку корзина работает на куках, то при удалении товара, нужно 
    ...
    🟠 создал стейт для того, что бы его тогглить и юсефект маунтил 
    при удалении товара корзину заново, добавил проверку на пустой 
    объект, что бы не рендерились товары без моделей, но в корзине 
    всегда остается один, который изчезает при нажатии на удалени и 
    при повторном маунте.
    думаю, нужно добавить зависимость в юзефект, но тогда зацыкливается
